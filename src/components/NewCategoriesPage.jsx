      ...
      >
        ...
        <div className="mt-auto flex items-center justify-between">
          <span className="text-xs text-gray-500">
            <span className="inline-block transform group-hover:scale-110 transition-transform duration-300">{count}</span> {count === 1 ? 'item' : 'items'}
          </span>
...
const NewCategoriesPage = ({ onNavigateToCategorySearch }) => {
  ...
  const serverSubcategories = [
    {
      ...
      description: "SQL, NoSQL, Vector Stores, and file storage servers",
      count: 10,
    ...
    },
    {
      ...
      description: "Search engines, web browsers, and content fetching",
      count: 8,
    ...
    },
    {
      ...
      description: "Git repositories, PRs, commits, and code management",
      count: 5,
    ...
    },
    {
      ...
      description: "Filesystem access, time utilities, and system tools",
      count: 9,
    ...
    },
    {
      ...
      description: "Messaging platforms, email, and notification systems",
      count: 6,
    ...
    },
    {
      name: "Analytics",
      slug: "analytics",
      keywords: ['analytics', 'metric', 'logging', 'monitor'],
      icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z",
      description: "Metrics, dashboards, and data visualization",
      count: 5,
    ...
    },
    {
      ...
      icon: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-9.618 5.04C2.131 12.332 2 13.15 2 14c0 4.562 2.722 8.45 7.06 10.514C10.927 25.504 12 24.508 12 23.382c0 1.126 1.073 2.122 2.94 1.132C19.278 22.45 22 18.562 22 14c0-.85-.13-1.668-.382-3.016z",
  ...
  const clientSubcategories = [
    {
      ...
      description: "Desktop clients and applications for interacting with AI models",
      count: 6,
    ...
    },
    {
      ...
      description: "Browser-based clients and web interfaces for AI services",
      count: 3, 
    ...
    },
    {
      ...
      description: "Code editors and IDEs with integrated AI and MCP support",
      count: 2,
    ...
    },
    {
      ...
      description: "Programming libraries, SDKs and frameworks",
      count: 2,
    ...
    },
    {
      ...
      description: "Browser extensions that integrate AI capabilities",
      count: 1,
    ...
    },
    {
      ...
      icon: "M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z",
      description: "Integrations with messaging platforms and chat services",
      count: 1,
    ...
    },
    {
      ...
      description: "Tools for building and orchestrating AI workflows",
      count: 1,
  ...
  const aiAgentSubcategories = [
    ...
    },
    {
      ...
      icon: "M13 10V3L4 14h7v7l9-11h-7z",
      description: "Independent task-completing agents with minimal supervision",
      count: 4,
    ...
    },
    {
      ...
      description: "Collaborative AI systems with multiple specialized agents",
      count: 3,
    ...
    },
    {
      ...
      description: "Information gathering, analysis, and knowledge management",
      count: 1,
    ...
    },
    {
      ...
      description: "Platforms and frameworks for creating custom AI agents",
      count: 2,
    ...
    },
    {
      ...
      description: "Content creation, art generation, and creative assistance",
      count: 1,
    ...
    },
    {
      ...
      description: "Automated data labeling and processing agents",
      count: 1,
    ...
    },
    {
      ...
      description: "AI agents that manage and execute task queues",
      count: 1,
    ...
    },
    {
      ...
      description: "Advanced memory and reasoning systems for AI agents",
      count: 1,
    ...
    <div className="container mx-auto p-4 min-h-screen">
        ...
        <div className="my-8 relative overflow-hidden">
          ...
          <div className="relative z-10 px-4 py-6">
            <h1 className="text-4xl sm:text-5xl font-bold text-white mb-4 tracking-tight">
              Browse by <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-indigo-400">Category</span>
            </h1>
            <p className="text-lg text-gray-300 mb-6 max-w-3xl">
              Explore our comprehensive collection of MCP resources organized by category.
              Find the perfect tools to enhance your AI capabilities.
            </p>
          </div>
        </div>
      </ScrollReveal>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
        ...
        <ScrollReveal direction="up" threshold={0.1} delay={50} once={true}>
          <CategoryHeroCard
            title="Ready to Use"
            description="Discover curated, production-ready AI solutions that will transform your workflow with no setup hassle."
        ...
        <ScrollReveal direction="up" threshold={0.1} delay={100} once={true}>
          <CategoryHeroCard
            title="MCP Servers"
            description="Connect Claude to external data sources, APIs, and services with these powerful server-side tools."
        ...
        <ScrollReveal direction="up" threshold={0.1} delay={150} once={true}>
          <CategoryHeroCard
            title="MCP Clients"
            description="Integrate Claude capabilities into your applications, websites, and tools with these client-side solutions."
        ...
        <ScrollReveal direction="up" threshold={0.1} delay={200} once={true}>
          <CategoryHeroCard
            title="AI Agents"
            description="Autonomous agents that help you accomplish complex tasks using advanced LLM capabilities and planning."
        ...
        <div className="mb-20">
          <div className="mb-8">
            ...
            <p className="text-gray-300 max-w-4xl mb-3">
              Curated, production-ready AI tools that will transform your workflow today. No setup hassle, just immediate value.
            </p>
            <Link 
              to="/ready-to-use" 
              onClick={(e) => {
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            <ScrollReveal direction="up" threshold={0.1} delay={50} once={true}>
              <SubcategoryCard
                name="Relevance AI"
                icon="M13 10V3L4 14h7v7l9-11h-7z"
                description="Build and deploy your AI workforce in minutes, no code required."
                count={1}
                color="indigo"
                linkTo="/ready-to-use"
                onClick={() => {
            ...
            <ScrollReveal direction="up" threshold={0.1} delay={100} once={true}>
              <SubcategoryCard
                ...
                description="Create AI chatbots that instantly understand your business documentation."
                count={1}
                color="blue"
                linkTo="/ready-to-use"
                onClick={() => {
            ...
            <ScrollReveal direction="up" threshold={0.1} delay={150} once={true}>
              <SubcategoryCard
                ...
                description="Create professional AI videos without cameras, studios, or actors."
                count={1}
                color="emerald"
                linkTo="/ready-to-use"
                onClick={() => {
            ...
            <ScrollReveal direction="up" threshold={0.1} delay={200} once={true}>
              <SubcategoryCard
                ...
                description="Create engaging content in seconds with AI-powered assistance."
                count={1}
                color="orange"
                linkTo="/ready-to-use"
                onClick={() => {
      ...
      <ScrollReveal direction="up" threshold={0.1} once={true}>
        <CategorySection
          title="MCP Servers"
          description="Access external data sources, APIs, and services through these server-side MCP tools"
          color="purple"
          icon="server"
      ...
      <ScrollReveal direction="up" threshold={0.1} once={true}>
        <CategorySection
          title="MCP Clients"
          description="Integrate Claude into your applications with these client-side tools and libraries"
          color="blue"
          icon="desktop"
      ...
      <ScrollReveal direction="up" threshold={0.1} once={true}>
        <CategorySection
          title="AI Agents"
          description="Autonomous agents that help accomplish complex tasks with advanced planning and reasoning"
          color="amber"
          icon="lightbulb"
          ...
          <div className="relative z-10">
            ...
            <div className="space-y-4 pl-4 border-l border-purple-500/20 group-hover:border-purple-500/30 transition-colors duration-500">
              <p className="text-gray-300 group-hover:text-gray-200 transition-colors duration-300">
                Model Context Protocol (MCP) resources are organized into categories based on their primary function 
                and the type of data or services they connect to. This organization helps you find the right MCP 
                resources for your specific AI use case.
              </p>
              
              <p className="text-gray-400 group-hover:text-gray-300 transition-colors duration-300">
                Each category contains specialized tools that extend Claude's capabilities in different ways. 
                You can browse by high-level category (Servers, Clients, Agents) or explore specific subcategories 
              ...
              <div className="flex items-center pt-2 text-sm text-purple-400 group-hover:text-purple-300 transition-colors duration-300">
                ...
                MCP provides secure access to external data sources and tools
              </div>
            </div>
          </div>
        </div>
