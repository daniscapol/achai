      ...
      <div className="container mx-auto p-10 relative">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center mb-6 group">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-gray-500 text-xs">AI Solutions Marketplace</span>
              </div>
            </div>
            <p className="text-sm mb-4">
              Explore AI solutions, tools, agents, and integrations to enhance your workflow. Find the perfect tools to maximize your productivity.
            </p>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                {[
                  ...
                  { label: 'Developer API', href: '#/api', badge: 'New' }
                ].map((item) => (
                  <li key={item.label}>
                    <a 
                      href={item.href} 
        ...
        <div className="mt-12 pt-8 border-t border-zinc-700/50 flex flex-col md:flex-row justify-between items-center text-sm">
          <div className="flex flex-wrap justify-center md:justify-start gap-x-6 gap-y-2 mb-4 md:mb-0">
            <span>&copy; 2025 AchAI. All rights reserved.</span>
